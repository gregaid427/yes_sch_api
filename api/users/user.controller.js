      ...
      // if not create user
        ...
        if (data.role == "parent") {
          ...
          pool.query(sqlQuery, (error, result) => {
            ...
            if (result.affectedRows == 1) {
              let sqlQuery1 = `insert into users (email,gender,createdAt,createdBy,pincode,role,active,password,parent,student,admin,superAdmin,feesManage,expenseManage,examManage,teacher ) values
          ('${data.email}','${data.gender}','${date}','${data.createdBy}',${userPin},'${data.role}','${data.active}','${hashedPass}','${parent}','${student}','${admin}','${superAdmin}','${feesManage}','${examManage}','${expenseManage}','${teacher}')`;
                  ...
                  transporter.sendMail(mailOptions, function (error, info) {
                    ...
                    if (error) {
                      ...
                      return res.status(200).json({
                        ...
                        Verification_mail:
                          "mail not sent - network Connectivity",
                      });
                    } else {
              ...
              res
                .status(500)
                .json({ success: 0, error: "internal server errorrrrrr" });
          });
        }
        if (data.role == "student") {
          ...
          pool.query(sqlQuery3, (error, result) => {
            ...
            sqlQuery = `insert into student (student_id,firstName,lastName,otherName,contact1,contact2,class,section,religion,dateofbirth) values
                 ('${student_id}','${data.firstName}','${data.lastName}','${data.otherName}','${data.contact1}','${data.contact2}','${data.class}','${data.section}','${data.religion}','${data.dateofbirth}')`;
        ...
        if (data.role == "staff") {
          ...
          sqlQuery = `insert into staff (sEmail,sGender,sLastName,sFirstName,sOtherName,contact1,contact2,address,staff_id ) values
          ('${data.email}','${data.gender}','${data.lastName}','${data.firstName}','${data.otherName}','${data.contact1}','${data.contact2}','${data.address}','${data.student_id}')`;
